...
robocopy "Engine/Assets" "Build\\Release Editor\\Assets" *.* /mir /w:0 /r:1 /v /log:"Build\\Release\\Assets.log"
...
robocopy "Assets" "Build\\Release Editor\\Assets" *.* /w:0 /r:1 /v /E /log:"Build\\Release\\Assets.log"
